...
function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-theme-bg text-white flex items-center justify-center relative overflow-hidden">
            ...
            <div
                className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-red-900/10 blur-[120px] rounded-full"/>
            ...
            >
                ...
                <div className="flex flex-col items-center mb-10">
                    <div
                        className="w-16 h-16 bg-red-600 rounded-2xl flex items-center justify-center font-black text-2xl mb-4">
                        CW
                    </div>

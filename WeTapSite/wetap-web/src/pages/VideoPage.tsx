        ...
        <div className="min-h-screen bg-black text-white">
          <div className="max-w-[1700px] mx-auto flex flex-col lg:flex-row gap-6 p-4 md:p-6">
            ...
            <div className="flex-1 lg:max-w-[calc(100%-400px)]">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-4 pb-4 border-b border-zinc-800">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-red-600 to-purple-700 flex-shrink-0" />
                  <div>
                    <p className="font-bold text-zinc-100">Канал Автора</p>
                    <p className="text-xs text-zinc-400">0 підписників</p>
                  </div>
                  <button className="ml-4 bg-white text-black px-4 py-2 rounded-full text-sm font-bold hover:bg-zinc-200 transition-colors">
                    Підписатися
                  </button>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center bg-zinc-800 rounded-full overflow-hidden">
                    <button className="flex items-center gap-2 px-4 py-2 hover:bg-zinc-700 transition-colors border-r border-zinc-700">
                      <ThumbsUp size={18} />
            ...
            <div className="w-full lg:w-[400px] flex-shrink-0 space-y-3">
              ...
              {isRecsLoading ? (
                  ...
                  recommendations?.items.map((item) => (
                      ...
                      >
                        <div className="relative w-40 h-24 flex-shrink-0 overflow-hidden rounded-lg bg-zinc-900">
                          <img

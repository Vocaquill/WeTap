...
export function VideoForm({
  ...
  return (
    <div className="min-h-screen bg-[#111216] text-white flex flex-col justify-between p-6 lg:p-10 font-sans relative">
      {(isLoading || isLoadingTag) && <LoadingOverlay />}

      {/* Схований файловий інпут для каверу */}
      <input
        ref={imageInputRef}
        type="file"
        name="image"
      ...
      {/* Схований файловий інпут для відео */}
      <input
        ref={videoInputRef}
        type="file"
        name="video"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mt-2">
            ...
            <div className="lg:col-span-7 space-y-6">
                  ...
                  <div className="relative">
                    ...
                    >
                      ...
                      {genresData?.items.map((genre: IGenreItemResponse) => (
                        <option key={genre.id} value={genre.id} className="bg-[#1c1d22] text-white">
                          {genre.name}
                        </option>
                      ))}
                    </select>
                  </div>
                  {errors.genreIds && <p className="text-red-500 text-xs mt-0.5">{errors.genreIds[0]}</p>}
                </div>
              ...
              <div className="space-y-3 pt-2">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Choose a cover that stands out and grabs the viewers' attention.</p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  >
                    <ImagePlus className="text-[#ff2a6d] mb-2 group-hover:scale-110 transition-transform" size={24} />
                  ...
                  {/* Preview Card */}
                  {imagePreview ? (
                    <div className="h-32 rounded-2xl overflow-hidden border border-white/10 bg-[#1c1d22] relative group">
                    ...
                    <div className="h-32 rounded-2xl bg-[#1c1d22]/50 border border-white/5 flex items-center justify-center text-zinc-600 text-xs">
                      No image
                    </div>
                  )}

                  <div className="h-32 rounded-2xl bg-[#1c1d22]/30 border border-white/5 hidden md:block" />

                  {/* Video Frame Selector Option */}
                  <div
                  ...
                  >
                    <Upload className="text-zinc-400 group-hover:text-white mb-2 transition-colors" size={20} />
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              {/* Video Preview Card */}
              <div className="bg-[#1c1d22] border border-white/5 rounded-3xl overflow-hidden p-3 space-y-4">
                ...
                <div className="px-2 pb-2">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-[10px] text-zinc-500 uppercase font-semibold">File name</p>
              ...
              <div className="bg-[#1c1d22] border border-white/5 rounded-3xl p-6 space-y-4">
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Choose when to publish your video and who can view it.</p>
                </div>

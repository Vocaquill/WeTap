...
export function VideoForm({
    ...
    const boxWrapperStyle = "p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-300 dark:border-zinc-800";

    return (
        <div
            className="relative min-h-screen bg-theme-bg text-theme-zinc-100 p-6 lg:p-10 flex flex-col justify-between transition-colors duration-300">
            {isLoading && <LoadingOverlay/>}

            <input ref={imageInputRef} type="file" name="image" accept="image/*" onChange={handleFileChange}
                   className="hidden"/>
            <input ref={videoInputRef} type="file" name="video" accept="video/*" onChange={handleFileChange}
                   className="hidden"/>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mt-6">
                        <div className="lg:col-span-7 space-y-6">
                            <div className="space-y-2">
                                <label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Назва відео
                                    *</label>
                                <input
                                    type="text"
                                    name="title"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Мова
                                        *</label>
                                    <select
                                        name="languageId"
                                    ...
                                    >
                                        <option value={0}
                                                className="bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100">Виберіть
                                            мову
                                        </option>
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Створити
                                        новий тег</label>
                                    <input
                                        type="text"
                                        value={tagInput}
                            ...
                            <div className="space-y-2 pt-2">
                                <h3 className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">Обкладинка
                                    відео</h3>
                                <div
                                ...
                                >
                                    {imagePreview ? (
                                        <>
                                            ...
                                            <div
                                                className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-2 backdrop-blur-xs">
                                                <ImagePlus className="text-white" size={24}/>
                                                <span
                                                    className="text-xs bg-[#ff2a6d] text-white px-3 py-1 rounded-full font-medium">Змінити обкладинку</span>
                                            </div>
                                        </>
                                    ) : (
                                        <>
                                            <ImagePlus
                                                className="text-zinc-500 dark:text-zinc-400 mb-2 group-hover:text-[#ff2a6d] group-hover:scale-110 transition-all"
                                                size={28}/>
                                            ...
                                            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 mt-1">Формат:
                                                16:9 (PNG, JPG)</p>
                                        </>
                                    )}
                                </div>
                        ...
                        <div className="lg:col-span-5 space-y-6">
                            <div className={`${cardContainerStyle} p-4 space-y-4`}>
                                <div
                                    className="aspect-video w-full rounded-xl overflow-hidden bg-zinc-50 dark:bg-zinc-950 flex items-center justify-center relative border border-zinc-200 dark:border-zinc-800">
                                    {videoPreview ? (
                                        ...
                                        >
                                            <div
                                                className="w-16 h-16 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center shadow-md group-hover:scale-105 transition-transform">
                                                <Upload size={28} className="text-[#ff2a6d]"/>
                                            </div>
                                            <div className="space-y-1">
                                                <p className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Відео
                                                    не вибрано</p>
                                                <p className="text-xs text-zinc-500 dark:text-zinc-400">Натисніть, щоб
                                                    обрати відеофайл</p>
                                            </div>
                                        </div>
                                    )}
                                ...
                                <div className="px-1">
                                    <div className="flex items-center justify-between mt-2">
                                        <div className="overflow-hidden">
                                            <p className="text-[10px] text-zinc-500 dark:text-zinc-400 uppercase font-semibold">Назва
                                                файлу</p>
                                ...
                                {errors.video && (
                                    <div
                                        className="mt-2 p-3 bg-red-500/10 border border-red-500/20 rounded-xl flex items-center gap-2">
                            ...
                            <div className={`${cardContainerStyle} p-6 space-y-4`}>
                                <div>
                                    <h3 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Приватність
                                        *</h3>
                                    <p className="text-xs text-zinc-500 dark:text-zinc-400">Виберіть, хто зможе бачити
                                        це відео.</p>
                                </div>
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className="pt-0.5">
                                                    <div
                                                        className={`w-4 h-4 rounded-full border flex items-center justify-center transition-colors ${isSelected ? 'border-[#ff2a6d]' : 'border-zinc-400 dark:border-zinc-600'}`}>
                                                        {isSelected &&

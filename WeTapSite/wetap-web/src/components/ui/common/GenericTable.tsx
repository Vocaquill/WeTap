            ...
            switch (lowerKey) {
                ...
                case 'avatarimage':
                    return {
                        ...
                        render: (item: any) => (
                            <div
                                className="w-14 h-14 rounded-2xl bg-zinc-900 border border-zinc-800 overflow-hidden shadow-inner group-hover:border-zinc-700 transition-colors">
                                {item[key] ? (
                                    <img
                                    ...
                                    <div className="w-full h-full flex items-center justify-center text-zinc-700 uppercase text-[10px] font-black">No
                                        Pic
                                    </div>
                                )}
                            </div>
